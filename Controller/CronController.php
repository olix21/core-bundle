            ...
            if ($order->getPayementMethod() == 3) {
                ...
                if (isset($payment) && $payment->getState() == 'approved') {
                    ...
                    $message = \Swift_Message::newInstance()
                        ...
                        ->setBody($this->renderView('DyweeOrderBundle:Email:mail-step2.html.twig', ['order' => $order]))
                        ...
                        if (!$shipment->getMailSended()) {
                            if ($shipment->getOrder()->isGift() == 1) {
                                $message = \Swift_Message::newInstance()
                                    ...
                                    ->setBody($this->renderView('DyweeOrderBundle:Email:mail-step5.html.twig', ['order' => $shipment->getOrder()]));
                                $message->setContentType('text/html');
                                $this->get('mailer')->send($message);
                            }
